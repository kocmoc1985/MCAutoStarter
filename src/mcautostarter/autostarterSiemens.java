 ...
 */
public final class autostarterSiemens implements Runnable {
...
//        new WindowCloser(windows_to_press_away, press_away_error_msgs);
    ...
    private void propertiesHandler() {
        ...
        mc_control_federals_name = props.getProperty("mc_control_name");
    ...
    private void sessionChecker() {
        try {
            ...
            Logger.getLogger(autostarterSiemens.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//            popup.add(openExport);
            ...
            trayIcon = new TrayIcon(image, "MCStarter", popup);
    ...
    private void checker(String mode) throws AWTException {
        ...
        while (mccontrol_monitoring == true) {
...
//                autostarterSiemens a = new autostarterSiemens("No monitoring just app launching");
                //
                options.jLabel3.setText("Args = off");
            } else if (argument.equals("sessions")) {
//                autostarterSiemens a = new autostarterSiemens("Only for", "testing how many sessions are currently running");
                //
                options.jLabel3.setText("Args = sessions");
                System.exit(0);
            } else if (argument.equals("forcemonitor")) {
//                autostarterSiemens a = new autostarterSiemens(0);
                //
            ...
            autostarterSiemens a = new autostarterSiemens();
        }
    }
